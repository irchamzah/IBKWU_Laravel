...
class ProfilController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        //validasi data
        $rules = [
            'tentang_h1' => 'required', 'string',
            'tentang_h2' => 'required', 'string',
            'tentang_p1' => 'required', 'string',
            'tentang_img1' => 'max:5000|mimes:jpeg,png,jpg,svg',
            'tentang_h3' => 'required', 'string',
            'tentang_p2' => 'required', 'string',
            'tentang_img2' => 'max:5000|mimes:jpeg,png,jpg,svg',
            'tentang_h4' => 'required', 'string',
            'tentang_p3' => 'required', 'string',
            'visi_h1' => 'required', 'string',
            'visi_h2' => 'required', 'string',
            'visi_p1' => 'required', 'string',
            'visi_h3' => 'required', 'string',
            'visi_p2' => 'required', 'string',
            'visi_h4' => 'required', 'string',
            'visi_p3' => 'required', 'string',
            'tujuan_h1' => 'required', 'string',
            'tujuan_h2' => 'required', 'string',
            'tujuan_p1' => 'required', 'string',
            'tujuan_h3' => 'required', 'string',
            'tujuan_p2' => 'required', 'string',
            'tujuan_h4' => 'required', 'string',
            'tujuan_p3' => 'required', 'string',
            'struktur_h1' => 'required', 'string',
            'struktur_h2' => 'required', 'string',
