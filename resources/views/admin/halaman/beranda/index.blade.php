                        ...
                        <div class="flex flex-wrap">
                            <div class="w-full self-center px-4 lg:w-1/2">
                                ...
                                <p class="font-medium text-secondary mb-10 leading-relaxed">
                                    <textarea name="home_p1" id="home_p1" cols="30" rows="10" type="text"
                                        class="h-32 block border border-grey-light w-full p-3 rounded mb-4 @error('home_p1') is-invalid @enderror"
                                        required autocomplete="home_p1" autofocus>{{$beranda->home_p1}}</textarea>
                                </p>
                            ...
                            <div class="w-full self-end px-4 lg:w-1/2">
                                <div class="relative mt-10 lg:mt-0 lg:right-0">
                                    <img src="/img/beranda/{{$beranda->home_img1}}" alt="Dhanang Eka Putra"
                                        class="relative w-96 bg-cover mx-auto ">
                                    <input type="file"
                                        class="block border border-grey-light w-full p-3 rounded mb-4 @error('home_img1') is-invalid @enderror"
                                        name="home_img1" accept="image/*">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-wrap">
                            <div class="w-full px-4 mb-10 lg:w-1/2">
                                <h4 class="font-bold uppercase text-primary text-lg mb-3">
                                    <input type="text" id="about_h1"
                                        class="block border border-grey-light w-full p-3 rounded mb-4 @error('about_h1') is-invalid @enderror"
                                        name="about_h1" value="{{$beranda->about_h1}}" required autocomplete="about_h1"
                                        autofocus>

                                </h4>
                                <h2 class="font-bold text-dark text-3xl mb-5 max-w-md lg:text-4xl dark:text-white">
                                    <input type="text" id="about_h2"
                                        class="block border border-grey-light w-full p-3 rounded mb-4 @error('about_h2') is-invalid @enderror"
                                        name="about_h2" value="{{$beranda->about_h2}}" required autocomplete="about_h2"
                                        autofocus>
                                </h2>
                                <p class="font-medium text-base text-secondary max-w-xl lg:text-lg">
                                    <textarea name="about_p1" id="about_p1" cols="30" rows="10" type="text"
                                        class="h-32 block border border-grey-light w-full p-3 rounded mb-4 @error('about_p1') is-invalid @enderror"
                                        required autocomplete="about_p1" autofocus>{{$beranda->about_p1}}</textarea>
                                </p>
                            </div>
                            <div class="w-full px-4 lg:w-1/2">
                                <h3 class="font-semibold text-dark text-2xl mb-4 lg:text-3xl lg:pt-12 dark:text-white">
                                    <input type="text" id="about_h3"
                                        class="block border border-grey-light w-full p-3 rounded mb-4 @error('about_h3') is-invalid @enderror"
                                        name="about_h3" value="{{$beranda->about_h3}}" required autocomplete="about_h3"
                                        autofocus>
                                </h3>
                                <p class="font-medium text-base text-secondary mb-6 lg:text-lg">
                                    <textarea name="about_p2" id="about_p2" cols="30" rows="10" type="text"
                                        class="h-32 block border border-grey-light w-full p-3 rounded mb-4 @error('about_p2') is-invalid @enderror"
                                        required autocomplete="about_p2" autofocus>{{$beranda->about_p2}}</textarea>
                                </p>
                            ...
                            <div class="max-w-xl mx-auto text-center mb-16">
                                <h4 class="font-semibold text-lg text-primary mb-2">
                                    <input type="text" id="galeri_h1"
                                        ...
                                        name="galeri_h1" value="{{$beranda->galeri_h1}}" required
                                ...
                                <h2 class="font-bold text-dark text-3xl mb-4 sm:text-4xl lg:text-5xl dark:text-white">
                                    <input type="text" id="galeri_h2"
                                        ...
                                        name="galeri_h2" value="{{$beranda->galeri_h2}}" required
                                        autocomplete="galeri_h2" autofocus>
                                </h2>
                                <p class="font-medium text-md text-secondary md:text-lg">
                                    <textarea name="galeri_p1" id="galeri_p1" cols="30" rows="10" type="text"
                                        class="h-32 block border border-grey-light w-full p-3 rounded mb-4 @error('galeri_p1') is-invalid @enderror"
                                        required autocomplete="galeri_p1" autofocus>{{$beranda->galeri_p1}}</textarea>
                                </p>
                            </div>
                        </div>
                ...
                <section id="mitra" class="pt-36 pb-32 bg-slate-800 dark:bg-slate-300">
                    <div class="container">
                        <div class="w-full px-4">
                            <div class="max-w-xl mx-auto text-center mb-16">
                                <h4 class="font-semibold text-lg text-primary mb-2">
                                    <input type="text" id="mitra_h1"
                                        class="bg-slate-700 block border border-grey-light w-full p-3 rounded mb-4 @error('mitra_h1') is-invalid @enderror"
                                        name="mitra_h1" value="{{$beranda->mitra_h1}}" required autocomplete="mitra_h1"
                                        autofocus>
                                </h4>
                                <h2 class="font-bold text-white text-3xl mb-4 sm:text-4xl lg:text-5xl dark:text-dark">
                                    <input type="text" id="mitra_h2"
                                        class="bg-slate-700 block border border-grey-light w-full p-3 rounded mb-4 @error('mitra_h2') is-invalid @enderror"
                                        name="mitra_h2" value="{{$beranda->mitra_h2}}" required autocomplete="mitra_h2"
                                        autofocus>
                                </h2>
                                <p class="font-medium text-md text-secondary md:text-lg">
                                    <textarea name="mitra_p1" id="mitra_p1" cols="30" rows="10" type="text"
                                        class="bg-slate-700 h-32 block border border-grey-light w-full p-3 rounded mb-4 @error('mitra_p1') is-invalid @enderror"
                                        required autocomplete="mitra_p1" autofocus>{{$beranda->mitra_p1}}</textarea>
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="max-w-xl mx-auto text-center mb-16">
                                <h4 class="font-semibold text-lg text-primary mb-2">
                                    <input type="text" id="blog_h1"
                                        ...
                                        name="blog_h1" value="{{$beranda->blog_h1}}" required autocomplete="blog_h1"
                                        autofocus>
                                </h4>
                                <h2 class="font-bold text-dark text-3xl mb-4 sm:text-4xl lg:text-5xl dark:text-white">
                                    <input type="text" id="blog_h2"
                                        class=" block border border-grey-light w-full p-3 rounded mb-4 @error('blog_h2') is-invalid @enderror"
                                        name="blog_h2" value="{{$beranda->blog_h2}}" required autocomplete="blog_h2"
                                        autofocus>
                                </h2>
                                <p class="font-medium text-md text-secondary md:text-lg">
                                    <textarea name="blog_p1" id="blog_p1" cols="30" rows="10" type="text"
                                        class=" h-32 block border border-grey-light w-full p-3 rounded mb-4 @error('blog_p1') is-invalid @enderror"
                                        required autocomplete="blog_p1" autofocus>{{$beranda->blog_p1}}</textarea>
                ...
                <section id="contact" class="pt-36 pb-32 dark:bg-slate-800">
                    <div class="container">
                        <div class="w-full px-4">
                            <div class="max-w-xl mx-auto text-center mb-16">
                                <h4 class="font-semibold text-lg text-primary mb-2">
                                    <input type="text" id="kontak_h1"
                                        class=" block border border-grey-light w-full p-3 rounded mb-4 @error('kontak_h1') is-invalid @enderror"
                                        name="kontak_h1" value="{{$beranda->kontak_h1}}" required
                                        autocomplete="kontak_h1" autofocus>
                                </h4>
                                <h2 class="font-bold text-dark text-3xl mb-4 sm:text-4xl lg:text-5xl dark:text-white">
                                    <input type="text" id="kontak_h2"
                                        class=" block border border-grey-light w-full p-3 rounded mb-4 @error('kontak_h2') is-invalid @enderror"
                                        name="kontak_h2" value="{{$beranda->kontak_h2}}" required
                                        autocomplete="kontak_h2" autofocus>
                                </h2>
                                <p class="font-medium text-md text-secondary md:text-lg"><textarea name="kontak_p1"
                                        id="kontak_p1" cols="30" rows="10" type="text"
                                        class=" h-32 block border border-grey-light w-full p-3 rounded mb-4 @error('kontak_p1') is-invalid @enderror"
                                        required autocomplete="kontak_p1" autofocus>{{$beranda->kontak_p1}}</textarea>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="w-full lg:w-2/3 lg:mx-auto">
                            ...
                            <div class="w-full px-4">
                                <a href="#">
                                    <div
                                        class="text-base font-semibold text-white bg-primary py-3 px-8 rounded-full w-full hover:opacity-80 hover:shadow-lg transition duration-500 items-center text-center mx-auto">
                                        Kirim</div>
                                </a>
                            </div>
                        </div>
