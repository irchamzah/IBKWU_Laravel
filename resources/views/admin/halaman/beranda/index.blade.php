...
<form action="{{route('admin.halaman.beranda.update', $beranda->id)}}" method="POST" enctype="multipart/form-data">
    ...
    <section id="slider" class="pt-10 bg-slate-100">
        <div class="">
            <div class="flex flex-wrap">
                            ...
                            <div class="overflow-hidden relative h-56 sm:h-64 xl:h-80 2xl:h-96">
                                ...
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    <div
                                        ...
                                        <a href="{{route('admin.halaman.blog.edit_blog', $post_berita->id)}}"
                                    ...
                                    <img src="/image/detail_blog/{{$post_berita->detail_blog_img}}"
                                        class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2 opacity-50"
                                        alt="...">
                                </div>
                                @endforeach
                                @else
        ...
        <div class="sm:container">
            <div class="w-full px-4">
                <div class="max-w-xl mx-auto text-center mb-5">
                    ...
                    <h2 class="font-bold text-dark  mb-5 text-3xl sm:text-4xl lg:text-4xl hover:text-primary"><input
                            type="text" id="pengumuman_h1"
                            ...
                            autocomplete="pengumuman_h1" autofocus></h2>
                    <hr>
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="bg-white  shadow-lg overflow-hidden mb-10">
                        ...
                        <div class="py-8 px-6">
                            <h3>
                                <a href="{{route('admin.halaman.blog.edit_blog', $post_pengumuman->id)}}"
                            ...
                            <a href="{{route('admin.halaman.blog.delete_blog', $post_pengumuman->id)}}"
        ...
        <div class="sm:container">
            <div class="flex flex-wrap">
                <div class="w-full px-4 text-center mb-5">
                    <h2 class="font-bold text-dark  mb-5 text-3xl sm:text-4xl lg:text-4xl">
                        <input type="text" id="yt_h1"
                            class="block border border-grey-light max-w-xl mx-auto w-full p-3  mb-4 @error('yt_h1') is-invalid @enderror"
    ...
    <section id="blog" class="pt-10 pb-10">
        <div class="sm:container">
            <div class="w-full px-4">
                <div class="max-w-xl mx-auto text-center mb-5">
                    {{-- <h4 class="font-semibold text-lg text-primary mb-2">{{$beranda->blog_h1}}</h4> --}}
                    <h2 class="font-bold text-dark text-3xl sm:text-4xl lg:text-4xl mb-5 hover:text-primary"><input
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="bg-white shadow-lg overflow-hidden mb-10">
                        ...
                        <div class="py-8 px-6">
                            ...
                            <a href="{{route('admin.halaman.blog.edit_blog', $post_berita->id)}}"
                                class="font-medium text-sm text-white bg-primary py-2 px-4 -lg hover:opacity-80">Edit</a>
                            <a href="{{route('admin.halaman.blog.delete_blog', $post_berita->id)}}"
                                class="font-medium text-sm text-white bg-red-500 py-2 px-4 -lg hover:opacity-80">Hapus</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="w-full px-4">
                <div class="max-w-xl mx-auto text-center mb-5">
                    ...
                    <h3 class="font-bold text-DARK text-3xl sm:text-4xl mb-5"><input type="text" id="lokasi_h1"
        ...
        <div class="sm:container">
            <div class="w-full px-4">
                <div class="max-w-xl mx-auto text-center mb-5">
                    ...
                    <h3 class="font-bold text-dark text-3xl sm:text-4xl mb-5 hover:text-primary"><input type="text"
                            id="galeri_h1"
            ...
            <div class="w-full px-4 flex flex-wrap justify-center  xl:mx-auto">
                ...
                <div class="p-4 md:w-1/3">
                    <div class=" shadow-md overflow-hidden"><a
                            href="{{route('admin.halaman.galeri.edit_produk', $detail_produk->id)}}">
