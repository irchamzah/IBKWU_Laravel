                ...
                <div class="w-full self-center px-4 ">
                    ...
                    <div class="w-full mx-auto">
                        ...
                        <div id="default-carousel" class="relative" data-carousel="static">
                            <!-- Carousel wrapper -->
                            <div class="overflow-hidden relative h-56 -lg sm:h-64 xl:h-80 2xl:h-96">
                            ...
                            <div class="flex absolute bottom-5 left-1/2 z-30 space-x-3 -translate-x-1/2">
                                <button type="button" class="w-3 h-3 -full" aria-current="false" aria-label="Slide 1"
                                    data-carousel-slide-to="0"></button>
                                <button type="button" class="w-3 h-3 -full" aria-current="false" aria-label="Slide 2"
                                    data-carousel-slide-to="1"></button>
                                <button type="button" class="w-3 h-3 -full" aria-current="false" aria-label="Slide 3"
                            ...
                            <button type="button"
                                ...
                                data-carousel-prev>
                                <span
                                    class="inline-flex justify-center items-center w-8 h-8 -full sm:w-10 sm:h-10 bg-white/30 group-hover:bg-white/50  group-focus:ring-4 group-focus:ring-white group-focus:outline-none">
        ...
        <div class="sm:container">
                ...
                <div class="max-w-xl mx-auto text-center mb-16">
                    ...
                    <h2 class="font-bold text-dark  mb-4 text-3xl sm:text-4xl lg:text-5xl hover:text-primary">
                        <input type="text" id="pengumuman_h1"
                            class="block border border-grey-light w-full p-3  mb-4 @error('pengumuman_h1') is-invalid @enderror"
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full px-4 lg:w-1/2 xl:w-1/3">
                    <div class="bg-white -xl shadow-lg overflow-hidden mb-10">
                        ...
                        <div class="py-8 px-6">
                            ...
                            <a href="#"
                                class="font-medium text-sm text-white bg-primary py-2 px-4 -lg hover:opacity-80">Baca
                                Selengkapnya</a>
                        </div>
                    </div>
                </div>
                @endforeach
                @else
                <p class="text-red-600 mx-auto border-collapse border-red-500 border-2 -xl p-4 bg-white">
                    Blog tidak tersedia.</p>
                @endif
            ...
            <div class="flex flex-wrap">
                <div class="w-full px-4 mb-10 lg:w-1/2">
                    ...
                    <h3 class="font-semibold text-dark text-2xl sm:text-3xl lg:text-4xl mb-4 lg:pt-10">
                        <input type="text" id="ig_h1"
                            class="block border border-grey-light w-full p-3  mb-4 @error('ig_h1') is-invalid @enderror"
                    ...
                    <div class="w-full px-4 aspect-video">
                        ...
                        <img src="/image/contoh_link_ig.png" alt="" class="my-3 -lg">
                ...
                <div class="w-full px-4 lg:w-1/2">
                    <h3 class="font-semibold text-dark text-2xl sm:text-3xl lg:text-4xl mb-4 lg:pt-10"><input
                            type="text" id="yt_h1"
                            class="block border border-grey-light w-full p-3  mb-4 @error('yt_h1') is-invalid @enderror"
                    ...
                    <div class="w-full px-4 aspect-video">
                        ...
                        <img src="/image/contoh_link_yt.png" alt="" class="my-3 -lg">
            ...
            <div class="w-full px-4">
                <div class="max-w-xl mx-auto text-center mb-16">
                    ...
                    <h2 class="font-bold text-dark text-3xl sm:text-4xl lg:text-5xl mb-4 hover:text-primary"><input
                            ...
                            class="block border border-grey-light w-full p-3  mb-4 @error('berita_h1') is-invalid @enderror"
        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full self-center px-4 lg:w-1/2">
                    ...
                    <a href="/profil"
                        class="text-base font-semibold text-white bg-primary py-3 px-8 -full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out">Selengkapnya
                        ></a>
                </div>
        ...
        <div class="sm:container">
            <div class="w-full px-4">
                <div class="max-w-xl mx-auto text-center mb-16">
                    ...
                    <h3 class="font-bold text-dark text-3xl mb-4 sm:text-4xl lg:text-5xl hover:text-primary"><input
                            ...
                            class="block border border-grey-light w-full p-3  mb-4 @error('galeri_h1') is-invalid @enderror"
            ...
            <div class="w-full px-4 flex flex-wrap justify-center  xl:mx-auto">
                ...
                <div class=" p-4 md:w-1/3">
                    <div class="-md shadow-md overflow-hidden"><a href="#">
            ...
            <div class="w-full px-4">
                <div class="max-w-xl mx-auto text-center mb-16">
                    ...
                    <h3 class="font-bold text-dark text-3xl mb-4 sm:text-4xl lg:text-5xl"><input type="text"
                            id="lokasi_h1"
                            class="block border border-grey-light w-full p-3  mb-4 @error('lokasi_h1') is-invalid @enderror"
                ...
                <div class="w-full lg:w-2/3 lg:mx-auto">
                    <div class="w-full px-4 mb-8">
                        ...
                        <input type="text" id="nama"
                            class="w-full bg-slate-200 text-dark p-3 -md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary" />
                    </div>
                    <div class="w-full px-4 mb-8">
                    ...
                    <div class="w-full px-4 mb-8">
                        ...
                        <textarea type="text" id="email"
                            class="w-full bg-slate-200 text-dark p-3 -md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary h-32"></textarea>
                    </div>
                    <div class="w-full px-4">
                        <button
                            class="text-base font-semibold text-white bg-primary py-3 px-8 -full w-full hover:opacity-80 hover:shadow-lg transition duration-500">Kirim</button>
                    </div>
                </div>
            </form> --}}
        </div>
