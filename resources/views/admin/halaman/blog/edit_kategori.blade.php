...
<form action="{{route('admin.halaman.blog.show_kategori.update_kategori', $kategori_blog->id)}}" method="POST"
            ...
            <div class="bg-white px-6 py-8 rounded shadow-md text-black w-full">
                <div class="form-group">
                    ...
                    <input type="text" id="kategori"
                        ...
                        name="kategori" value="{{$kategori_blog->kategori}}" required autocomplete="kategori" autofocus>
                </div>
