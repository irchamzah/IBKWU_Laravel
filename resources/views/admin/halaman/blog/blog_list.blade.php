                    ...
                    <div class="container">
                                ...
                                <h2
                                    ...
                                    <span class="bg-gradient-to-r from-purple-500 to-pink-500 text-dark bg-clip-text">
                                        <input form="saveForm" type="text" id="sorotan_h1"
                                            class="block border border-grey-light w-full p-3  mb-4 @error('sorotan_h1') is-invalid @enderror"
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <div class="w-full px-4 lg:w-1/2 xl:w-1/3">
                                <div class="bg-white -xl shadow-lg overflow-hidden mb-10 dark:bg-slate-800">
                                    <img src="/image/detail_blog/{{$rekomendasiBlog->detail_blog_img}}"
                ...
                <section id="tenant" class="pt-36 pb-32 bg-slate-100 dark:bg-slate-800">
                    <div class="container">
                                ...
                                <div class="mt-5 w-full sm:w-96">
                                    <div class="relative mb-4 flex w-full flex-wrap items-stretch">
                                        <input form="searchForm" name="query" type="text"
                                            class="bg-white relative m-0 -mr-px block w-[1%] min-w-0 flex-auto -l border border-solid border-neutral-300 bg-transparent bg-clip-padding px-3 py-1.5 text-base font-normal text-neutral-700 outline-none transition duration-300 ease-in-out focus:border-primary focus:text-neutral-700 focus:shadow-te-primary focus:outline-none dark:text-neutral-200 dark:placeholder:text-neutral-200"
                                            placeholder="Cari blog" aria-label="Search" aria-describedby="searchForm" />
                                        <button form="searchForm"
                                            class="relative z-[2] flex items-center -r bg-primary px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-opacity-80 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg"
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <div class="w-full px-4 lg:w-1/2 xl:w-1/3">
                                <div class="bg-white  shadow-lg overflow-hidden mb-10 dark:bg-dark">
                                    <img src="/image/detail_blog/{{$detail_blog->detail_blog_img}}" alt="Gambar"
