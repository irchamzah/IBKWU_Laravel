            ...
            <div
                ...
                <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1 text-right md:text-center">
                        <h2 class="font-bold uppercase text-gray-600">Edit Beranda</h2>
                    </div>
                </div>
            </div>
            <!--/Metric Card-->
        ...
        <a href="/admin/halaman/profil">
            <div class="bg-gradient-to-b from-pink-200 to-pink-100 border-b-4 border-pink-500 rounded-lg shadow-xl p-5">
                <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1 text-right md:text-center">
                        <h2 class="font-bold uppercase text-gray-600">Edit Profil</h2>
                    </div>
                </div>
            </div>
        </a>
        ...
        <a href="/admin/halaman/galeri">
            <div
                ...
                <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1 text-right md:text-center">
                        <h2 class="font-bold uppercase text-gray-600">Edit Galeri Tenant</h2>
                    </div>
                </div>
            </div>
        </a>
    ...
    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
        ...
        <a href="/admin/halaman/footer">
            <div
                ...
                <div class="flex flex-row items-center">
                    <div class="flex-shrink pr-4">
                        <div class="rounded-full p-5 bg-purple-600"><i class="fas fa-server fa-2x fa-inverse"></i></div>
                    </div>
                    <div class="flex-1 text-right md:text-center">
                        <h2 class="font-bold uppercase text-gray-600">Edit Footer</h2>
                    </div>
                </div>
            </div>
        </a>
