...
@section('title', 'Edit Foto Produk Galeri Tenant')
                    ...
                    <div class="container">
                        <div class="w-full px-4 flex flex-wrap justify-center xl:w-10/12 xl:mx-auto ">
                            <div class="mb-12 p-4 md:w-1/2">
                                <div id="show-modal" class="-md shadow-md overflow-hidden hover:opacity-80">
                                    <img src="/image/foto_produk/{{$foto_produk->produk_img1}}" alt="" width="w-full">
                                    @error('produk_img1')
                                    <small class="text-red-600">{{$message}}</small>
                                    @enderror
                                    <input type="file"
                                        class="block border border-grey-light w-full p-3  mb-4 @error('produk_img1') is-invalid @enderror"
                                ...
                                <h3 class="font-semibold text-xl text-dark mt-5 mb-3 dark:text-white text-center">
                                    ...
                                    <input type="text" id="produk_h1"
                                        class="block border border-grey-light w-full p-3  mb-4 @error('produk_h1') is-invalid @enderror"
                                ...
                                <div class="font-medium text-base text-secondary text-justify">
                                    ...
                                    <textarea type="text" id="editor1" name="produk_p1" placeholder="Deskripsi foto.."
                                        class="w-full p-3 -md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary h-96">{{$foto_produk->produk_p1}}</textarea>
                                </div>
