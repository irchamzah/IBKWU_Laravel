                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <div class="w-full p-4 lg:w-3/4">
                                        <h1 class="font-bold text-3xl my-5 text-justify">
                                            ...
                                            <input type="text" id="judul_h1"
                                                ...
                                                name="judul_h1" placeholder="Judul Produk.." required
                                        ...
                                        <div class="font-medium text-base text-dark text-justify mt-7 mb-3">
                                            <textarea type="text" id="editor1" name="deskripsi_p1"
                                                class="w-full p-3 -md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary h-96"></textarea>
                                        </div>

                                        <!--Metric Card-->
                                        <div class="w-min mx-auto">
                                            <button href="/admin/halaman/galeri/edit_produk/tambah_foto">
                                                <div
                                    ...
                                    <div class="w-full p-4 lg:w-1/4">
                                        <div class="">
                                            ...
                                            <!--Metric Card-->
                                            <button class="w-full" href="/admin/halaman/galeri/edit_produk/tambah_link">
                                                <div
                                                    class=" bg-primary text-white hover:opacity-90 text-center -lg p-2">
                                                    Tambah Kontak
                                                </div>
                                            </button>
                                            <!--/Metric Card-->
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <input type="text" id="link_ig"
                                                    ...
                                                    name="link_ig" placeholder="Kode link instagram.." required
                                                    autocomplete="link_ig" autofocus>
                                            </div>
