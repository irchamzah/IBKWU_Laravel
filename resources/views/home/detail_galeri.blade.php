...
<body class="font-poppins">
        ...
        <div class="flex items-center px-4">
          ...
          <nav id="nav-menu"
            ...
            <ul class="block lg:flex">
              ...
              <li class="group">
                <a href="/profil"
                  class="text-base text-dark py-2 mx-8 flex group-hover:text-primary dark:text-white">Profil</a>
              </li>
              <li class="group">
                <a href="/galeri"
                  class="text-base text-dark py-2 mx-8 flex group-hover:text-primary dark:text-white">Galeri Tenant</a>
              </li>
              <li class="group">
                <a href="/blog"
  ...
  <footer class="bg-dark pt-24 pb-12">
    <div class="container">
      ...
      <div class="w-full pt-10 border-t border-slate-700">
        ...
        <p class="font-medium text-xs text-slate-500 text-center">Dibuat oleh <a href="https://instagram.com/irchamzah"
            target="_blank" class="font-bold text-primary">Irchamzah Fikri Ababil</a>, menggunakan <a
            href="https://tailwindcss.com" target="_blank" class="font-bold text-sky-500">Tailwind CSS</a>.</p>
      </div>
    </div>
  </footer>
  {{-- Footer End --}}
  ...
  {{-- Modal --}}
  <div id="modal"
    class="h-screen w-full fixed left-0 top-0 flex justify-center items-center bg-dark bg-opacity-50 hidden dark:bg-slate-500 dark:bg-opacity-50">
    <div class="bg-white rounded shadow-lg w-10/12 lg:w-8/12 xl:w-6/12 2xl:w-5/12 dark:bg-slate-800 dark:text-white">
      ...
      <div class="p-3">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis illum eius, soluta magni quos temporibus
        placeat a praesentium nostrum pariatur!
      </div>
