            ...
            <div id="slider" class="sl-slider-wrapper">
                ...
                <div class="sl-slider">
                    ...
                    <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25"
                        ...
                        <div class="bg-img img-fluid"><img src="/img/fotoslider/{{$slider->image}}" alt="" class=" "
                ...
                <div class="row">
                    ...
                    <ul class="project-wrapper wow animated fadeInUp">
                        <li class="portfolio-item">
                            <img src="/home/img/portfolio/item.jpg" class="img-responsive"
                        ...
                        <li class="portfolio-item">
                            <img src="/home/img/portfolio/item2.jpg" class="img-responsive"
                        ...
                        <li class="portfolio-item">
                            <img src="/home/img/portfolio/item3.jpg" class="img-responsive"
                                alt="Lorem Ipsum is simply dummy text of the printing and typesetting ndustry. ">
                            <figcaption class="mask">
                                <h3>Wall street</h3>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting ndustry. </p>
                        ...
                        <li class="portfolio-item">
                            <img src="/home/img/portfolio/item4.jpg" class="img-responsive"
                                alt="Lorem Ipsum is simply dummy text of the printing and typesetting ndustry.">
                            <figcaption class="mask">
                                <h3>Wall street</h3>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting ndustry. </p>
                        ...
                        <li class="portfolio-item">
                            <img src="/home/img/portfolio/item5.jpg" class="img-responsive"
                                alt="Lorem Ipsum is simply dummy text of the printing and typesetting ndustry. ">
                            <figcaption class="mask">
                                <h3>Wall street</h3>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting ndustry. </p>
                        ...
                        <li class="portfolio-item">
                            <img src="/home/img/portfolio/item6.jpg" class="img-responsive"
                                alt="Lorem Ipsum is simply dummy text of the printing and typesetting ndustry. ">
                            <figcaption class="mask">
                                <h3>Wall street</h3>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting ndustry. </p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 wow animated fadeInRight">
                        <address class="contact-details">
                            <h3>KONTAK KAMI</h3>
                            <p><i class="fa fa-pencil"></i>Jl. Mastrip, Kotak Pos 164 – Tegalgede,
                                Sumbersari,<span>Kabupaten Jember,</span> <span>Jawa Timur 68124</span></p><br>
                    ...
                    <div class="footer-social">
                        <ul>
                            ...
                            <li class="wow animated zoomIn" data-wow-delay="1.2s"><a
                                    href="https://www.youtube.com/channel/UC4yzoGuKkCL_8FzI-B-x83A"><i
