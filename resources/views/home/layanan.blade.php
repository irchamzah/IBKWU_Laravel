  ...
  <div class="sm:container">
    <div class="w-full px-4">
      <div class="max-w-xl mx-auto text-center mb-5">
        ...
        <h2 class="font-bold text-dark mb-5 text-3xl sm:text-4xl">Layanan
        </h2>
        <hr>
          ...
          <div class="mt-5 w-full sm:w-96">
            <div class="relative mb-4 flex w-full flex-wrap items-stretch">
              ...
              <button form="searchForm"
                class="relative z-[2] flex items-center bg-primary px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white hover:bg-sky-600 focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg"
        ...
        <div class="w-full px-4 lg:w-1/2 xl:w-1/3">
          <div class="bg-white shadow-lg overflow-hidden mb-10">
            ...
            <div class="py-8 px-6">
              ...
              <div class="font-medium text-base text-secondary mb-5 truncate mt-2 max-h-20">
