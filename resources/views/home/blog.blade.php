        ...
        <div class="flex items-center px-4">
          ...
          <nav id="nav-menu"
            ...
            <ul class="block lg:flex">
              ...
              {{-- <li class="group">
                <a href="#mitra"
                  class="text-base text-dark py-2 mx-8 flex group-hover:text-primary dark:text-white">Mitra</a>
              </li> --}}
              {{-- <li class="group">
                <a href="#contact"
                  class="text-base text-dark py-2 mx-8 flex group-hover:text-primary dark:text-white">Kontak</a>
              </li> --}}
      ...
      <div class="w-full px-4">
        <div class="max-w-xl mx-auto text-center mb-16">
          ...
          <h2 class="animate-bounce font-bold text-dark text-3xl mb-4 sm:text-4xl lg:text-5xl dark:text-white"><span
              class="bg-gradient-to-r from-purple-500 to-pink-500 text-transparent bg-clip-text">Rekomendasi Blog</span>
          </h2>
          ...
          <div class="mb-3 xl:w-96">
            <div class="relative mb-4 flex w-full flex-wrap items-stretch">
              <input type="search"
                ...
                placeholder="Cari Judul Blog" aria-label="Search" aria-describedby="button-addon1" />
              <button
