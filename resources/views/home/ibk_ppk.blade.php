...
@section('menu-3', 'text-white bg-sky-600')
  ...
  <div class="sm:container">
    <div class="w-full px-4">
      <div class="max-w-xl mx-auto text-center mb-10">
        ...
        <h2 class="font-bold text-dark text-3xl mb-4 sm:text-4xl lg:text-5xl">IBK & PPK
        </h2>
        <hr>
          ...
          <div class="mt-5 w-full sm:w-96">
            <div class="relative mb-4 flex w-full flex-wrap items-stretch">
              <input form="searchForm" name="query" type="text"
                class="bg-white relative m-0 -mr-px block w-[1%] min-w-0 flex-auto border border-solid border-neutral-300 bg-transparent bg-clip-padding px-3 py-1.5 text-base font-normal text-neutral-700 outline-none transition duration-300 ease-in-out focus:border-primary focus:text-neutral-700 focus:shadow-te-primary focus:outline-none"
                placeholder="Cari post" aria-label="Search" aria-zdescribedby="searchForm" />
              <button form="searchForm"
                class="relative z-[2] flex items-center bg-primary px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg"
        ...
        <div class="w-full px-4 lg:w-1/2 xl:w-1/3">
          <div class="bg-white shadow-lg overflow-hidden mb-10">
            ...
            <div class="py-8 px-6">
              ...
              <a href="{{route('blog.detail_blog', $detail_blog->slug)}}"
                class="font-medium text-sm text-white bg-primary py-2 px-4g hover:opacity-80">Baca
                Selengkapnya</a>
            </div>
          </div>
        </div>
